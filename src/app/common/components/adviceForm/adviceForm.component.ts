...
import { THREAD_MANAGEMENT_URLS, ADVICE_MANAGEMENT_URLS, GENERICS, ENV}  from '../../../app.constant';
import { $WebSocket } from 'angular2-websocket/angular2-websocket';
import { SessionService } from '../../sessionService';
import { IOffer, ICategory } from '../../interfaces/offer';

@Component({
  selector: 'adviceForm',
  templateUrl: './adviceForm.html',
  styleUrls: ['./adviceForm.scss']
})
